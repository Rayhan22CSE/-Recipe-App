...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildHomeDashboard(BuildContext context, RecipeProvider recipeProvider, List displayRecipes) {
    return SafeArea(
  ...
  Widget _buildMealPlanPlaceholder(BuildContext context) {
    return Scaffold(
      backgroundColor: AppTheme.backgroundColor,
      appBar: AppBar(
        title: const Text(
          'Meal Plan',
          style: TextStyle(color: Color(0xFF1E1E24), fontWeight: FontWeight.bold),
        ),
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text(
                'Plan your breakfast, lunch, and dinner recipes for the week in advance.',
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> pages = [
      _buildHomeDashboard(context, recipeProvider, displayRecipes),
      const FavoritesScreen(),
      _buildMealPlanPlaceholder(context),
      const ProfileScreen(),
    ];
